# Event sourcing queue adapter technical guide
...
See [delivery guarantees](../docs/delivery-guarantees.md) for duplicate windows, fault and
...
delivery, and operations guidance.
