# Event sourcing outbox adapter technical guide
...
This pre-v1 adapter requires Go 1.27.0, pgx v5, the event-sourcing PostgreSQL
...
outbox, and operations guidance.
