...
run_gate() {
    ...
    case "${selected}" in
        ...
        licenses)
            ...
            if [[ "${module_path}" != "github.com/faustbrian/go-event-sourcing" &&
                "${module_path}" != github.com/faustbrian/go-event-sourcing/* ]]; then
            ...
            run_go_tool \
                ...
                go-licenses \
                check ./... \
                --ignore "github.com/faustbrian/go-event-sourcing"
            ;;
        sbom)
            applicable security || { skip_not_applicable security; return; }
